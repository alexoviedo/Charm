...
## Status
- State: active
- Source of truth: code under `components/`, `main/`, `web/`, and tests in `tests/unit/` + `web/tests/`
...
6. **Web runtime** (`web/`) — operator UI for flash, monitor, config, and validation aids.
...
- See `HARDWARE_VALIDATION_PACK.md` for mandatory physical validation matrix.
