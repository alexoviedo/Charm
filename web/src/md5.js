// Browser-safe MD5 implementation for esptool image hashing.
// Input is expected as a binary string (each charCode in [0,255]).
...
function md5blk(binaryString, offset) {
...
export function md5HexFromBinaryString(binaryString) {
  const state = [1732584193, -271733879, -1732584194, 271733878];
  const length = binaryString.length;
  let i;

  for (i = 64; i <= length; i += 64) {
    md5cycle(state, md5blk(binaryString, i - 64));
  }
